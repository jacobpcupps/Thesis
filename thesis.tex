...
\begin{document}
	...
	This offering of empathy continues the founding ethos of \textit{NPR} and its
	...
	music, nor even in creating music, but rather an ethos of understanding
	based in sonic exposure and practices of listening.  

	This ethos of understanding resonates with the theories 
	...
	framework for the ecologies of attention, music, and understanding
	...
	I take many cues from sound studies, particularly Pauline Oliveros...

	Echoing Oliveros, Odell describes a way of engaging with the 
	...
	conversations, and travel which casually educate their privileged 
	counterparts. 
	...
	Leonard spoke this this conflict directly with his comment in the New 
	...
	part due to executive producer Joan Cooney’s trust of her artists and 
	...
	Jon Stone, who wrote, produced, directed, and acted on the program new
	...
	must have an inner-city set. For urban children, the sets of traditional	television, enchanted castles, circuses, toymakers workshops, were
	completely foreign spaces. But ``For a preschool child
	...
	\textit{The Electric Company.}\autocite[218]{Davis} There is another 
	way, however, of looking at the problem of funding and leftist politics. 	So far the question has been ``if Sesame Street was so 
	...
	teach them skills such as how to read. \autocite[23]{Cooney} She writes 
	``in the opinion of most, a television program would be very useful 
	which would teach young children how to think, not what to think.'' This 	is non-striation par excellence: the student is not guided down a 
	...
	Going forward, when my analysis refers to aspects of Sesame Street as 
	``ecological,'' ``deschooled,'' or ``anarchist,'' these are not to imply	that executive producer Joan Cooney was an anarchist media theorist who 
	...
	team faced lead them to a particular philosophy of design which, by way 	of a sort of convergent evolution, lies so close the above philosophies 
	...
	coercion.'' Is this anarchism? In many ways no, but the results, again, 
	...
	gone overlooked. This is germane to scholars of Sesame Street, 
	television, and children’s media. On the other side, this is also 
	relevant---no, critical---to musical pedagogy more broadly. In a sense, 	I am attempting to radicalize \ses and thereby normalize anarchism and 
	...
	global pandemic. What can be found in the Sesame Street archive which 
	...
	This is not, mind you, a paper on how deschooling can save education and 	how Sesame Street gives us a convenient case study to this end. Illich 
